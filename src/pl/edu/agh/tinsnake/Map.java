...
public class Map implements Serializable {
	...
	/**
	 * Called after creating the map - stores the map sizes for the given zoom level (used for displaying lines on the map).
	 * Implemented on list because of the bug with serialization of the HashMap in Android (has to be called in order of increasing zoom).
	 *
